...
public class Bot extends PircBot {
	...
	protected void onMessage(String channel, String sender, String login,
		...
		if (args[0].equalsIgnoreCase(main.prefix + "help")) {
			this.sendNotice(sender, "Commands Avaiable: " + main.prefix + "help, ");
			this.sendNotice(sender,
					"OP Only Commands: " + main.prefix + "op, " + main.prefix + "deop, " + main.prefix + "voice, " + main.prefix + "devoice, " + main.prefix + "save");
		}

		if (args[0].equalsIgnoreCase(main.prefix + "paste")) {
			this.sendMessage(channel, "http://pastebin.com/");
		}

		super.onMessage(channel, sender, login, hostname, message);
	}

	protected void onNotice(String sender, String sourceLogin,
		...
		if (perm) {
			if (args[0].equalsIgnoreCase(main.prefix + "help")) {
				this.sendNotice(sender, main.prefix + "topic <topic> -- set topic in " + main.channel + ".");
				this.sendNotice(sender, main.prefix + "say <message> -- send a channel-wide notice to " + main.channel + ".");
				this.sendNotice(sender, main.prefix + "notice <user> <message> -- send message to <user>");
			}
			...
			if (args[0].equalsIgnoreCase(main.prefix + "say")) {
				...
				msg = msg.trim();
				this.sendMessage(main.channel, msg);
			}
	...
	protected void onPrivateMessage(String sender, String login,
		...
		if (perm) {
			if (args[0].equalsIgnoreCase(main.prefix + "help")) {
				this.sendMessage(sender,  main.prefix + "topic <topic> -- set topic in " + main.channel + ".");
				this.sendMessage(sender, main.prefix + "say <message> -- send a channel-wide notice to " + main.channel + ".");
				this.sendMessage(sender, main.prefix + "notice <user> <message> -- send a notice to <user>");
			}
			if (args[0].equalsIgnoreCase(main.prefix + "topic")) {
				String topic = "";
				for (int i = 1; i < args.length; i++) {
	...
	private void joinServer() {
		try {
			...
			joinServer();
			this.sendMessage("nickserv", "ghost " + main.name + " "
					+ main.password);
